...
1. (2022 TACL) **Causal Inference in Natural Language Processing: Estimation, Prediction, Interpretation and Beyond.**
...
1. (2024 arXiv) **Causal Inference with Large Language Model: A Survey.**
   _Jing Ma_.
...
1. (2024 ICLR) **Can Large Language Models Infer Causation from Correlation?**
...
1. (2024 TMLR) **Causal Reasoning and Large Language Models: Opening a New Frontier for Causality.**
   _Emre Kıcıman, Robert Ness, Amit Sharma, Chenhao Tan_.
   [[pdf](https://arxiv.org/pdf/2305.00050)]
1. (2024 ACL Findings) **Are LLMs Capable of Data-based Statistical and Causal Reasoning? Benchmarking Advanced 
...
1. (2024 arXiv) **LLMs Are Prone to Fallacies in Causal Inference.**
   *Nitish Joshi, Abulhair Saparov, Yixin Wang, He He*.
   [[pdf](https://arxiv.org/pdf/2406.12158)]
1. (2024 arXiv) **CLEAR: Can Language Models Really Understand Causal Graphs?**
   _Sirui Chen, Mengying Xu, Kun Wang, Xingyu Zeng, Rui Zhao, Shengjie Zhao, Chaochao Lu_. 
   [[pdf](https://arxiv.org/pdf/2406.16605)]
1. (2024 arXiv) **Evaluating Interventional Reasoning Capabilities of Large Language Models.**
...
1. (2023 TMLR) **Causal Parrots: Large Language Models May Talk Causality But Are Not Causal.**
...
1. (2025 arXiv) **Causal-Copilot: An Autonomous Causal Analysis Agent.**
   _Xinyue Wang, Kun Zhou, Wenyi Wu, et al._
   [[pdf](https://arxiv.org/pdf/2504.13263)]
1. (2025 ICLR) **Causal Order: The Key to Leveraging Imperfect Experts in Causal Inference.**
...
1. (2024 arXiv) **Efficient Differentiable Discovery of Causal Order.** _Mathieu Chevalley, Arash Mehrjou, Patrick Schwab_. 
   [[pdf](https://arxiv.org/pdf/2410.08787)]
1. (2024 arXiv) **Knowledge Graph Structure as Prompt: Improving Small Language Models Capabilities for Knowledge-based Causal Discovery.**
   _Yuni Susanti, Michael Färber_.
   [[pdf](https://arxiv.org/abs/2407.18752)]
1. (2024 arXiv) **Multi-Agent Causal Discovery Using Large Language Models.**
   _Hao Duong Le, Xin Xia, Zhang Chen_.
   [[pdf](https://arxiv.org/abs/2407.15073)]
1. (2024 ACL) **Open Event Causality Extraction by the Assistance of LLM in Task Annotation, Dataset, and Method.**
   _Kun Luo, Tong Zhou, Yubo Chen, Jun Zhao, Kang Liu_.
   [[pdf](https://aclanthology.org/2024.neusymbridge-1.4/)]
1. (2024 arXiv) **Large Language Models for Constrained-Based Causal Discovery.**
...
1. (2024 arXiv) **Large Language Models are Effective Priors for Causal Graph Discovery.**
   _Victor-Alexandru Darvariu, Stephen Hailes, Mirco Musolesi_.
   [[pdf](https://arxiv.org/abs/2405.13551)]
1. (2024 ACL) **Identifying while Learning for Document Event Causality Identification.**
   _Cheng Liu, Wei Xiang, Bang Wang_.
   [[pdf](https://arxiv.org/abs/2405.20608)]
1. (2024 arXiv) **ALCM: Autonomous LLM-Augmented Causal Discovery Framework.**
   _Elahe Khatibi, Mahyar Abbasian, Zhongqi Yang, Iman Azimi, Amir M. Rahmani_.
   [[pdf](https://arxiv.org/abs/2405.01744)]
1. (2024 COLM) **LLM4Causal: Democratized Causal Tools for Everyone via Large Language Model.**
   _Haitao Jiang, Lin Ge, Yuhe Gao, Jianian Wang, Rui Song_.
   [[pdf](https://openreview.net/attachment?id=H1Edd5d2JP&name=pdf)]
1. (2024 arXiv) **Bridging Causal Discovery and Large Language Models: A Comprehensive Survey.**
...
1. (2024 arXiv) **Causal Graph Discovery with Retrieval-Augmented Generation based Large Language Models.**
...
1. (2024 SSRN) **Towards Automating Causal Discovery in Financial Markets and Beyond.**
...
1. (2023 arXiv) **From Query Tools to Causal Architects: Harnessing Large Language Models for Advanced Causal Discovery from Data.**
   _Taiyu Ban, Lyvzhou Chen, Xiangyu Wang, Huanhuan Chen_.
   [[pdf](https://arxiv.org/abs/2306.16902)]
1. (2023 arXiv) **Causal Reasoning and Large Language Models: Opening a New Frontier for Causality.**
   _Emre Kıcıman, Robert Ness, Amit Sharma, Chenhao Tan_.
   [[pdf](https://arxiv.org/pdf/2305.00050)]
...
1. (2023 arXiv) **Towards Causal Foundation Model: on Duality between Causal Inference and Attention.**
   _Jiaqi Zhang, Joel Jennings, Agrin Hilmkil, Nick Pawlowski, Cheng Zhang, Chao Ma_.
   [[pdf]](https://arxiv.org/pdf/2310.00809)
1. (2023 EMNLP) **CRAB: Assessing the Strength of Causal Relationships Between Real-world Events**
...
1. (2022 ICML) **Causal Inference Principles for Reasoning about Commonsense Causality**
...
1. (2024 arXiv) **C2P: Featuring Large Language Models with Causal Reasoning.**
...
1. (2024 TMLR) **Mechanistic Interpretability for AI Safety -- A Review.** _Leonard Bereska, Efstratios Gavves_. [[pdf](https://arxiv.org/pdf/2404.14082)]

#### 2.3.1 Causal Behavioral Tests

1. (2025 ICLR) **GSM-Symbolic: Understanding the Limitations of Mathematical Reasoning in Large Language Models.**
...
#### 2.3.3 Causal Analysis of Model Behavior (e.g., memorization, generalization)

1. (2025 ACL) **Causal Estimation of Tokenisation Bias.**
_Pietro Lesci, Clara Meister, Thomas Hofmann, Andreas Vlachos, Tiago Pimentel_. [[pdf](https://aclanthology.org/2025.acl-long.1374.pdf)]

1. (2024 ACL Best Paper) **Causal Estimation of Memorisation Profiles.**
_Pietro Lesci, Clara Meister, Thomas Hofmann, Andreas Vlachos, Tiago Pimentel_. [[pdf](https://arxiv.org/pdf/2406.04327.pdf)]
...
1. (2017 NeurIPS, MPI, discover causal graphs behind data) **Avoiding Discrimination through Causal Reasoning.** _Niki Kilbertus, Mateo Rojas-Carulla, Giambattista Parascandolo, Moritz Hardt, Dominik Janzing, Bernhard Schölkopf_. [[pdf](https://arxiv.org/pdf/1706.02744.pdf)]
...
1. (2011 ACL) **Minimally Supervised Event Causality Identification.**
...
2. (2019 IJCAI Oral) **Estimating Causal Effects of Tone in Online Debates.**
   _Dhanya Sridhar and Lise Getoor_. [[pdf](https://arxiv.org/pdf/1906.04177.pdf)]

### 3.2 Psychology and Behavior

1. (2021 ICWSM) **The Effect of Moderation on Online Mental Health Conversations.**
   _David Wadden, Tal August, Qisheng Li, Tim Althoff_. 
   [[pdf](https://arxiv.org/pdf/2005.09225.pdf)]
   <br>[Summary] Cause: moderation in online mental health conversations, effect: psychological improvements. Method: natural experiment (comparing data before and after moderators are introduced).

1. (2019 ICWSM) **A social media study on the effects of psychiatric medication use.** _Koustuv Saha, Benjamin Sugar, John Torous, Bruno Abrahao, Emre Kıcıman, Munmun De Choudhury_. 
   [[pdf](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7152507/pdf/nihms-1578147.pdf)]
   <br>[Summary] Cause: psychiatric drugs, confounder: previous Twitter posts, effect: psychopathology. Method: stratified propensity score matching.

1. (Psychological Science 2019) **Increasing vegetable intake by emphasizing tasty and enjoyable attributes: A randomized controlled multisite intervention for taste-focused labeling.** _Bradley Turnwald, et al._ 
   [[pdf](https://journals.sagepub.com/doi/pdf/10.1177/0956797619872191)]
   <br>[Summary] Cause: taste-focused vs. health-focused labels, effect: vegetable intake. Method: RCT.

1. (2018 ICWSM) **Using longitudinal social media analysis to understand the effects of early college alcohol use.**
   _Emre Kiciman, Scott Counts, Melissa Gasser_. 
   [[pdf](http://kiciman.org/wp-content/uploads/2018/10/college_alcohol_tweets_icwsm18e.pdf)]
...
1. (2018 ICML) **Estimating causal effects of exercise from mood logging data.**
   ...
   <br>[Summary] Cause: daily activities, effect: wellness markers (e.g., mood), confounder: text of mood triggers. Method: Propensity score matching.

1. (2017 CWSM) **The Language of Social Support in Social Media and its Effect on Suicidal Ideation Risk.** _Munmun De Choudhury, Emre Kıcıman_. 
   [[pdf](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5565730/pdf/nihms891351.pdf)]
   <br>[Summary] Cause: linguistic clues of Reddit comments, effect: suicidal attempt.

1. (Political Behavior, 2017) **Tweetment Effects on the Tweeted: Experimentally Reducing Racist Harassment.** _Kevin Munger_. 
   [[pdf](https://link.springer.com/content/pdf/10.1007/s11109-016-9373-5.pdf)]
   <br>[Context] Study includes results showing that harassment reduction was most effective when the bot account had a high follower count and was perceived as being of the same race as the subject (White), reducing the use of racist slurs by 27% among that group.
...
1. (2017 ICWSM) **Estimating the Effect Of Exercising On Users' Online Behavior.**
   ...
   <br>[Summary] Cause: offline activities (gym check-ins), effect: user interests on Twitter. Discovery: interest shift reduces significantly after users start exercising.

1. (2017 CSCW) **Distilling the outcomes of personal experiences: A propensity-scored analysis of social media.** _Alexandra Olteanu, Onur Varol, Emre Kiciman_. 
   [[pdf](https://dl.acm.org/doi/pdf/10.1145/2998181.2998353?casa_token=U8iCSHz-uGUAAAAA:i9qcF0UCEH-lYKhTE9aA5RNMxFlvqfPW0tiHtUsh_lkmdV1F1O9ko9jPIl_nb8Cx5Rbtf4nn5JGq)]

1. (CHI 2016) **Discovering shifts to suicidal ideation from mental health content in social media.** _Munmun De Choudhury, Emre Kiciman, Mark Dredze, Glen Coppersmith, Mrinal Kumar_. 
   [[pdf](https://dl.acm.org/doi/pdf/10.1145/2858036.2858207?casa_token=ZJKLrg8LAOsAAAAA%3Aecs8HsunRyeUeD_De6Dx15_nPRZ1-mmjiXfAEXLpr25wwz6ywzQcJuZqWjJQIyibEGxZTOkULd1h)]
   <br>[Summary] Cause: linguistic and social interaction on Reddit, effect: suicidal attempt. Method: propensity score matching.

1. (2014 ACL) **The effect of wording on message propagation: Topic- and author-controlled natural experiments on Twitter.** _Chenhao Tan, Lillian Lee, Bo Pang_. 
   [[pdf](https://www.aclweb.org/anthology/P14-1017.pdf)]
...
1. (2019 JMLR) **Generalization Bounds and Representation Learning for Estimation of Potential Outcomes and Causal Effects.**
   _Fredrik D. Johansson, Uri Shalit, Nathan Kallus, David Sontag_.
   [[pdf](https://www.jmlr.org/papers/volume23/19-511/19-511.pdf)]

1. (2017 ICML) **Estimating individual treatment effect: generalization bounds and algorithms.**
   _Fredrik D. Johansson, Uri Shalit, David Sontag_.
   [[pdf](http://proceedings.mlr.press/v70/shalit17a/shalit17a.pdf)]

1. (2017 NeurIPS) **Causal Effect Inference with Deep Latent-Variable Models.**
...
1. (2016 PASA) **A causal, data-driven approach to modeling the Kepler data.**
...
1. (2025 NeurIPS Spotlight) **Do-PFN: In-Context Learning for Causal Effect Estimation**
   _Jake Robertson, Arik Reuter, Siyuan Guo, Noah Hollmann, Frank Hutter, Bernhard Schölkopf_. [[pdf](https://arxiv.org/pdf/2506.06039)]

1. (2025 NeurIPS Spotlight) **CausalPFN: Amortized causal effect estimation via in-context learning**
   _Vahid Balazadeh, Hamidreza Kamkari, Valentin Thomas, Benson Li, Junwei Ma, Jesse C Cresswell, Rahul G Krishnan_. [[pdf](https://arxiv.org/pdf/2506.07918)]
...
1. (Focus on SCM) **Causality: Models, Reasoning, and Inference.** _Judea Pearl_. [[Book, 2009](https://bayes.cs.ucla.edu/BOOK-2K/)]
...
1. **Causal Inference for The Brave and True.** [[website](https://matheusfacure.github.io/python-causality-handbook/landing-page.html)]
